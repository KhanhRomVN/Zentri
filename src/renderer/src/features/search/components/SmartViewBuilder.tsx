...
const SmartViewBuilder: FC<SmartViewBuilderProps> = ({ isOpen, onClose, onSave, editView }) => {
                    ...
                    <div className="grid grid-cols-8 gap-1 max-h-[200px] overflow-y-auto custom-scrollbar">
                      <button
                        ...
                        className={cn(
                          ...
                          !form.icon ? 'bg-primary/20 text-primary' : 'text-muted-foreground hover:bg-dropdown-item-hover',
                        )}
                        title="None"
                      >
                        <X className="w-3 h-3" />
