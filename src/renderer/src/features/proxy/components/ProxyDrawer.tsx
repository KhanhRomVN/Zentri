...
const ProxyDrawer: React.FC<ProxyDrawerProps> = ({ isOpen, onClose, proxy }) => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed right-0 top-0 h-full w-[450px] bg-background border-l border-border z-[101] shadow-2xl transition-transform duration-300 ease-in-out transform flex flex-col',
