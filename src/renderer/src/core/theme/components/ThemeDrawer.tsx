...
const ThemeDrawer: React.FC<ThemeDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-6 bg-background custom-scrollbar">
        <div className="mb-8">
      ...
      <div className="p-5 border-t border-border bg-background flex gap-3">
        <button
          onClick={onClose}
          className="flex-1 py-2.5 rounded-lg bg-secondary text-secondary-foreground hover:bg-secondary/80 transition-colors font-medium border border-border"
        >
          Close
        </button>
      </div>
